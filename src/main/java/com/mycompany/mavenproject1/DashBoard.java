...
public class DashBoard extends javax.swing.JFrame {
    ...
    MangoDBConnection mdb = new MangoDBConnection();
    List<Document> projectData = mdb.getProjectData();
    ...
    private void initComponents() {
        ...
        Dsb_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order No.", "Client Name", "Project Timeline", "Warranty Status", "Project Status", "Action"
            }
        ));
